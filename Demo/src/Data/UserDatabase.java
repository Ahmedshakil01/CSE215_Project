...
import User.UserInformation;
	...
	public class UserDatabase {
		...
		public Account getAccount(String n)
		{
		...
		public Account getAccount(String n, String p)
		{
			for(int i=0;i<account.size();i++)
			{
		...
		public boolean isAccountNumberUnique(String n)
		{
			for(int i=0;i<account.size();i++)
			{
				if(account.get(i).getAccuntNo().equals(n))
		...
		public void saveData()
		{
			...
			try
			{
				BufferedWriter bw = new BufferedWriter(new FileWriter(new File("G:\\Fall19\\CSE215L\\Practice\\Demo\\resources\\AccountList.txt")));
				for(int i=0;i<account.size();i++)
				{
		...
		public void loadData()
		{
			try
			{
				BufferedReader br = new BufferedReader(new FileReader(new File("G:\\Fall19\\CSE215L\\Practice\\Demo\\resources\\AccountList.txt")));
				String type;
